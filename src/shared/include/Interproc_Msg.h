...
struct Interproc_Msg_t {
    ...
    enum Interproc_Command_t command : 8 STRUCT_INIT;
    u8 data[7] STRUCT_INIT;
    CRC checksum STRUCT_INIT;
} ALIGN;

#ifdef __cplusplus
using Interproc_Command_t = Interproc_Msg_t::Interproc_Command_t;
#else
...
struct Interproc_Msg_t interproc_msg_make(Interproc_Command_t command, const void *const data);
